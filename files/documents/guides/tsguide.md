...
* Import type: module[module_import]
  * Example: import * as foo from'...';
  * Use for: TypeScript imports
* Import type: named[destructuring_import]
  * Example: import {SomeThing}from '...';
  * Use for: TypeScript imports
* Import type: default
  * Example: import SomeThingfrom '...';
  * Use for: Only for otherexternal code thatrequires them
* Import type: side-effect
  * Example: import '...';
  * Use for: Only to importlibraries for theirside-effects on load(such as customelements)
...
* Style: UpperCamelCase
  * Category: class / interface / type / enum / decorator / typeparameters / component functions in TSX / JSXElement typeparameter
* Style: lowerCamelCase
  * Category: variable / parameter / function / method / property /module alias
* Style: CONSTANT_CASE
  * Category: global constant values, including enum values. SeeConstants below.
* Style: #ident
  * Category: private identifiers are never used.
